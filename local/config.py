...
class TrainOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--window_stride', type=int, default=256, help='input window_stride')
        self.parser.add_argument('--sample_rate', type=int, default=16000, help='input sample_rate')
        self.parser.add_argument('--num_classes', type=int, default=1211, help='num_classes')
        ...
        self.parser.add_argument('--frame_slice', type=int, default=128, help='frame_slice')        
        self.parser.add_argument('--utter_num', type=int, default=10, help='utter_num')
        self.parser.add_argument('--segment_num', type=int, default=1, help='utter_num')
        self.parser.add_argument('--frame_slice_steps', type=int, default=50, help='frame_slice_steps')               
        self.parser.add_argument('--feat_type', type=str, default='fbank', help='feat_type')                     
        ...
        self.parser.add_argument('--rnn_hidden_size', type=int, default=128, help='dnn_hidden_dim')
        ...
        self.parser.add_argument('--attention_head_num', type=int, default=1, help='attention_head_num')
        self.parser.add_argument('--embedding_loss_lamda', type=float, default=1., help='class_loss_lamda')
        self.parser.add_argument('--penalty_loss_lamda', type=float, default=0.1, help='penalty_loss_lamda')   
        ...
        self.parser.add_argument('--epochs', type=int, default=100, help='number of hours to train for')
        self.parser.add_argument('--start_epoch', default=0, type=int, metavar='N', help='manual hours number (useful on restarts)')    
        ...
        self.parser.add_argument('--max_norm', default=400, type=int, help='Norm cutoff to prevent explosion of gradients')
        self.parser.add_argument('--learning_anneal', default=1.1, type=float, help='Annealing applied to learning rate every epoch')
        ...
        self.parser.add_argument('--min_acc_impr', default=0.5, type=float, help='min_acc_impr')
